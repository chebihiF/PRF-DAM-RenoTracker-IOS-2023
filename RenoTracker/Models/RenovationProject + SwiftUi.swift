//
//  RenovationProject + SwiftUi.swift
//  RenoTracker
//
//  Created by CHEBIHI FAYCAL on 23/5/2023.
//
...
extension RenovationProject {
    ...
    var percentComplete: Double {
        let completePunchListItems = punchList.filter{puchListItem in
            puchListItem.status == .complete
        }
